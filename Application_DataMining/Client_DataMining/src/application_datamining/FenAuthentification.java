...
public class FenAuthentification extends javax.swing.JFrame {
    ...
    private void jButton_ConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ConnexionActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, ReponseLUGANAP.WRONG_USER_PASSWORD_MESSAGE, "Erreur", JOptionPane.ERROR_MESSAGE);
            jPasswordField.setText("");
        }
        else
        {
            ...
            if (Rep != null) 
            {
                if(Rep.getCode() == ReponseLUGANAP.LOGIN_OK)
                {
                    ...
                    java.awt.EventQueue.invokeLater(() -> {
                        new Application_DataMining(getClient()).setVisible(true);
                    });
